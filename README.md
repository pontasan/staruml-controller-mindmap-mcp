...
4. The HTTP server starts — all Mind Map Diagram tools become available via MCP
...
```bash
claude mcp add staruml-mindmap node /absolute/path/to/staruml-controller-mindmap-mcp/dist/index.js
```
